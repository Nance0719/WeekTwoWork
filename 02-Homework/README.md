...
WHEN I load their portfolio(check)
THEN I am presented with the developer's name, a recent photo, and links to sections about them, their work, and how to contact them(check)
WHEN I click one of the links in the navigation(check)
THEN the UI scrolls to the corresponding section(check)
